    ...
    dataObj : function(link, callback) {
        request(link, function (err, resp, body) {
            ...
            $('.result').each(function () {
                ...
                //The following calls the jobPage function, which requests the data from 
                //the job listing link, tests to see if it's on indeed rather than an 
                //external site, and returns the data. However, since a large number of the pages 
                //were on other sites, I decided not to go with this feature. 
